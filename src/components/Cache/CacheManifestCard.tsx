...
export function CacheManifestCard({
  ...
  const archColor: ThemeColor = manifest.architecture === 'arm64' ? 'rose' : manifest.architecture === 'x86_64' ? 'blue' : 'neutral';
  ...
  return (
    <Panel
      ...
      className={classNames('transition-opacity duration-200', isDeleting && 'opacity-40 pointer-events-none')}
      style={{
    ...
    >
      ...
      <div className="flex items-start justify-between p-4 pb-3">
        ...
        <div className="text-right shrink-0">
          <div className="text-xl font-bold text-neutral-800 dark:text-neutral-100 leading-none tabular-nums">{formatCacheSize(manifest.cache_size)}</div>
      ...
      <div className="px-4 py-3 space-y-2">
        ...
        {minReq && (
          <div className="flex items-center gap-2 flex-wrap pt-0.5">
            ...
            {minReq.cpu != null && <span className="text-[10px] font-medium text-neutral-500 dark:text-neutral-400">{minReq.cpu} CPU</span>}
            {minReq.memory != null && (
              <>
      ...
      <div className="flex items-center justify-end px-4 pb-3">
        <IconButton
          tooltip="Delete Catalog Manifest Item"
          variant="ghost"
          size="sm"
          icon="Trash"
          color="rose"
