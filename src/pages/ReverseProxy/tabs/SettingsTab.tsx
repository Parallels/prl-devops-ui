                        ...
                        {corsEnabled && (
                            <div className="pl-3 border-l-2 border-sky-200 dark:border-sky-700 space-y-3">
                                <FormField
                                    ...
                                    description='Enter origins and press Enter. Use * for all.'
                                >
                                    <TagInput
                                        values={origins}
                                        placeholder="https://example.com"
                                        onChange={(v) => { setOrigins(v); markDirty(); }}
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {HTTP_METHODS.map((m) => (
                                            <button
                                                ...
                                                disabled={!canUpdate || corsDisabled}
                                                className={`px-2.5 py-1 rounded-md text-xs font-semibold transition-colors ${methods.includes(m)
                                ...
                                <FormField
                                    ...
                                    description='Enter header names and press Enter.'
                                >
                                    <TagInput
                                        values={headers}
                                        placeholder="Content-Type"
                                        onChange={(v) => { setHeaders(v); markDirty(); }}
                                        disabled={!canUpdate || corsDisabled}
