...
import { Tabs, MultiToggle, Toggle, Button } from '../../../controls';
import { TabsVariant, TabsSize, TabsOrientation, TabsJustify, TabItem } from '../../../controls/Tabs';
                ...
                panel: (
                    <div className="mt-4 grid gap-3 md:grid-cols-2">
                        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                            ...
                            <p className="text-xs text-slate-500">Healthy · last deploy 3 minutes ago</p>
                        </div>
                        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
