...
import { getButtonColorClasses } from './Theme';
import { iconAccentHover, iconAccentRing } from './ButtonTypes';
...
export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  trailingIcon?: IconName | React.ReactElement;
  loading?: boolean;
  iconOnly?: boolean;
  accent?: boolean;
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const srOnlyContent =
      typeof children === 'string' ? children : ariaLabel ? ariaLabel : undefined;
    ...
    return (
      ...
      >
        ...
        {!loading &&
          renderIcon(trailingIcon, size as IconSize, classNames('flex-shrink-0', sizeConfig.icon))}
      </button>
    );
  }
);
