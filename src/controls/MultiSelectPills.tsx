...
const colorMap = {
  ...
  blue: {
    selected:
      'border-blue-500 bg-blue-500 text-white dark:bg-blue-500 dark:border-blue-500 hover:opacity-70',
...
const MultiSelectPills: React.FC<MultiSelectPillsProps> = ({
  ...
  return (
    ...
    >
      ...
      {description && (
        <p className="text-xs text-neutral-500 dark:text-neutral-400 pb-2">{description}</p>
      )}
