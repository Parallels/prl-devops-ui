...
const MultiProgressBar: React.FC<MultiProgressBarProps> = ({
    ...
    const tooltipSegment = tooltip ? segments.find(s => s.key === tooltip.key) : null;
        ...
        <div className={classNames(className)}>
            ...
            <div className="flex items-start justify-between mb-2">
                <div className="flex flex-col">
                    ...
                    {secondaryLabel && (
                        <span className={classNames(secondaryLabelClasses)}>{secondaryLabel}</span>
                    )}
                </div>
                {totalLabel && (
                ...
                createPortal(
                    ...
                    >
                        <div className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-lg px-3 py-2 text-xs whitespace-nowrap shadow-xl ring-1 ring-black/10 dark:ring-black/5">
                            <p className="font-semibold leading-tight">{tooltipSegment.label}</p>
