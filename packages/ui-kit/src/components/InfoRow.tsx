...
export type InfoRowPadding = 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl';
...
const sizeTokens: Record<InfoRowSize, SizeToken> = {
    xs: { defaultPadding: 'py-1',   horizontalPadding: 'px-3', defaultLabelWidth: 'w-16', text: 'text-[10px]' },
    sm: { defaultPadding: 'py-1.5', horizontalPadding: 'px-3', defaultLabelWidth: 'w-20', text: 'text-xs'    },
    md: { defaultPadding: 'py-2',   horizontalPadding: 'px-4', defaultLabelWidth: 'w-24', text: 'text-sm'    },
    lg: { defaultPadding: 'py-2.5', horizontalPadding: 'px-4', defaultLabelWidth: 'w-28', text: 'text-base'  },
};
    ...
    return (
        ...
        >
            ...
            >
                ...
                {tooltipVisible && copyText && (
                    <ValueTooltip text={copyText} />
                )}
