...
const Select = forwardRef<HTMLSelectElement, SelectProps>(function Select(
  ...
  const caret = useMemo(
    () =>
      showCaret ? (
        <span className={classNames('pointer-events-none absolute inset-y-0 flex items-center', sizeToken.iconRight, tokens.icon)}>{renderIcon('ArrowDown', undefined, sizeToken.iconSize)}</span>
      ) : null,
