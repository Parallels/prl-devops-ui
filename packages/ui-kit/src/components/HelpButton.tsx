...
const mdComponents: Components = {
  ...
  tbody: ({ children }) => (
    <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800/80">{children}</tbody>
  ),
  tr: ({ children }) => (
...
function computePopoverPosition(
  ...
  placement: HelpButtonPlacement,
  maxWidth: number,
): { style: React.CSSProperties; resolvedPlacement: "top" | "bottom" | "left" | "right" } {
