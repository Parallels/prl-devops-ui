  ...
  (
    ...
    const descriptionNode = description ? (
      descriptionPlacement === "inline" ? (
        <span
          id={descriptionId}
          className={classNames(sizeStyles.description, "text-neutral-500 dark:text-neutral-400", disabled && "text-neutral-400 dark:text-neutral-500")}
        >
          {description}
        </span>
      ) : (
    ...
    const textNode =
      label || descriptionNode ? (
        ...
        >
          {label && (
            <span className={classNames(sizeStyles.label, "font-medium text-neutral-900 dark:text-neutral-100", disabled && "text-neutral-500 dark:text-neutral-400")}>
              {label}
            </span>
          )}
          {descriptionNode}
