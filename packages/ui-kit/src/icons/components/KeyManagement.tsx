...
export const KeyManagement = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props} ref={ref}>
    ...
    <g id="remote_hosts_management_key" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <path
        ...
        transform="translate(8.0033, 8.0087) scale(-1, 1) translate(-8.0033, -8.0087)"></path>
    </g>
  </svg>
));
