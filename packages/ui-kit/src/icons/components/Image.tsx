...
export const Image = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={ref}>
  ...
  <circle cx="8" cy="9" r="2" stroke="#000000" strokeLinejoin="round" />
</svg>
));
