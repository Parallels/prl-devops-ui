...
export const Cache = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props} ref={ref}>
    ...
    <g id="catalog_cache" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <path
        ...
        id="Combined-Shape" fill="currentColor" fillRule="nonzero"></path>
    </g>
  </svg>
));
