...
export const Idea = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg  fill="currentColor" viewBox="-4 0 19 19" xmlns="http://www.w3.org/2000/svg" className="cf-icon-svg" {...props} ref={ref}>
  <path
